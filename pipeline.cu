...
extern "C" void forward_pass(float* X, float* W1, float* B1, float* W2, float* B2, float* out,
    ...
    // delete t_h; delete t_z_relu; delete t_y; delete t_y_softmax;
    // delete t_z; delete t_z_relu; delete t_r;
